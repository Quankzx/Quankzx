...
Full-Stack / .NET Developer specializing in e-commerce automation and backend systems. Experienced in building **.NET 8 Web APIs**, **Background Worker Services**, **API integrations**, **watchdog services**, and **asynchronous data-processing workflows**. Strong technical foundation in system reliability, **SQL Server / PostgreSQL** query optimization, asynchronous processing, and production support.

---

## 🛠️ TECHNICAL & DOMAIN SKILLS

* **Backend Development:** `.NET 8` / `.NET 7`, `ASP.NET Core Web API`, `Clean Architecture`, `Background Worker Services`, `EF Core`, `Dapper`, `RESTful APIs`, `OAuth2`, `JWT`.
...
* **Databases & Performance:** `PostgreSQL 16`, `MS SQL Server`, `Index Optimization (INCLUDE)`, `Query Optimization`, `AES-256 / GZip Credential Encryption`.
* **AI & Workflow Automation:** `LLM-Assisted Development (Claude, ChatGPT, Copilot)`, `Model Context Protocol (MCP) Integration`, `AI Code Review & Verification`, `AI-Driven Refactoring & Test Generation`.
* **DevOps & Infrastructure:** `Docker`, `Git/GitHub`, `Nginx`, `IIS`, `Postman`, `Linux / Windows Server`.
...
### **FPT APTECH ACADEMY** — *Ho Chi Minh City, Vietnam*
> **Higher Diploma in Software Engineering (International Programmer)** &nbsp;|&nbsp; *Jan 2022 – Dec 2023*
